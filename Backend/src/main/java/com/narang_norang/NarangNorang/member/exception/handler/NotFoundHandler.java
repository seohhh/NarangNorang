package com.narang_norang.NarangNorang.member.exception.handler;
    ...
    public ResponseEntity<String> renderDefaultPage(NoHandlerFoundException ex) {
        ...
        if (url.startsWith("/api/")) {
            ...
            try {
                ...
                e.printStackTrace();
                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("There was an error completting the action");
            }
        }
    }
}
