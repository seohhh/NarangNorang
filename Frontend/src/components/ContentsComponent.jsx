          ...
          <div>
            ...
            <Card style={{ width: "24rem", height: "30rem", margin: "3rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text style={{ margin: "1rem" }}>
                  노래에 맞춰 멈춰라!! 노래가 다시 시작되기 전까지 움직이지
                  않는다면 좋은 결과를 받을 수 있을 거에요.
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
          <div>
            <Card style={{ width: "24rem", height: "30rem", margin: "3rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text style={{ margin: "1rem" }}>
                  아이에게 정신적인 발달과 심리적인 안정을 주는 율동, 아이들이
                  음악에 맞춰 즐겁게 율동을 즐길 수 있습니다.
                </Card.Text>
              </Card.Body>
            </Card>
            <Card style={{ width: "24rem", height: "30rem", margin: "3rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text style={{ margin: "1rem" }}>
                  술래의 자세를 따라해보세요. 잘 따라 한다면 좋은 결과를 받을 수
                  있을 거에요.
                </Card.Text>
              </Card.Body>
            </Card>
